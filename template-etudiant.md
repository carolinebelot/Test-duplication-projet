...
| :---- | :---- | :---- | :---- | :---- |
| Ex : **Next.js 15** | Framework Full-stack | [docs](https://www.google.com/search?q=https://nextjs.org) | Architecture unifiée et Server Components | Performance, SEO et simplification de la stack (pas d'API REST séparée) |
|  |  |  |  |  |
